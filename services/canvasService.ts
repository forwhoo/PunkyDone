...
const CANVAS_TOOLS: any[] = [
  {
    ...
    function: {
      ...
      description:
        "Get the user's Top Artists with names, play counts, and image URLs.",
      parameters: {
        type: "object",
        properties: {
          limit: { type: "number" },
  ...
  },
  {
    ...
    function: {
      name: "get_top_songs",
      description:
        "Get the user's Top Songs with title, artist, album, and play counts.",
      parameters: {
        type: "object",
        properties: {
          limit: { type: "number" },
  ...
  },
  {
    ...
    function: {
      name: "get_top_albums",
      description:
        "Get the user's Top Albums with title, artist, cover art, and play counts.",
      parameters: {
        type: "object",
        properties: {
          limit: { type: "number" },
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Get overall listening statistics (minutes, tracks, trends, sessions).",
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Render a complete React TSX component. Use this for the FINAL output. The code must be a valid React functional component using available Shadcn UI components.",
      parameters: {
        type: "object",
        properties: {
          title: { type: "string" },
          ...
          code: {
            type: "string",
            description:
              "Self-contained TSX code. Import components directly as if they were in scope (e.g. <Button>). Do not include import statements. Define one main component (e.g. function App() { ... }) and return it.",
          },
        },
...
5.  **Interactive**: Add hovereffects, animations with framer-motion, and micro-interactions.
