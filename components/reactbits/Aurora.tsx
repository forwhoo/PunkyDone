...
export default function Aurora({ colorStops = ['#5227FF', '#7cff67', '#5227FF'], amplitude = 1.0, blend = 0.5, speed = 1.0, time }: AuroraProps) {
  ...
  useEffect(() => {
    ...
    const update = (t: number) => {
      ...
      program.uniforms.uTime.value = (propTime ?? t * 0.01) * propSpeed * 0.1;
