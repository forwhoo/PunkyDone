...
export const CardTitle = ({ children, className = "" }: CardProps) => (
  <h3
    className={`font-semibold leading-none tracking-tight text-[17px] ${className}`}
  >
    {children}
  </h3>
);
...
export const Badge = ({
  ...
  return (
    <div
      className={`inline-flex items-center rounded text-[10px] font-bold uppercase tracking-wide px-1.5 py-0.5 ${variants[variant]} ${className}`}
    >
      {children}
    </div>
  );
