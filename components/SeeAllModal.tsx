                                ...
                                <div className="flex-1 flex flex-col md:flex-row md:items-center gap-6">
                                    <div className="flex items-center justify-between">
                                        <h2 className="text-3xl font-bold text-[#141413] tracking-tight flex items-center gap-3">
                                            {title}
                                            <span className="text-sm font-normal text-[#141413]/40 bg-[#e8e6dc] px-2 py-0.5 rounded-full">
                                    ...
                                    <div className="relative group w-full md:max-w-md">
                                        <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-[#141413]/40 group-focus-within:text-[#141413] transition-colors" size={18} />
                                        <input
                                            type="text"
                                            value={searchQuery}
                                    ...
                                    {processedItems.map((item, index) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                {/* Image */}
                                                <div className={`
                                                    relative z-10 overflow-hidden bg-white flex-shrink-0 border border-white/[0.08] group-hover:border-white/30 transition-all shadow-lg
                                                    ${viewMode === 'grid'
                                                ...
                                                <div className={`relative z-10 min-w-0 ${viewMode === 'grid' ? 'w-full' : 'flex-1'}`}>
                                                    <h3 className={`font-semibold text-[#141413] truncate group-hover:text-[#141413]/90 transition-colors ${viewMode === 'grid' ? 'text-base mb-1' : 'text-sm'}`}>
                                                        {item.name || item.title}
                                                    </h3>
                                                    <p className={`text-xs text-[#141413]/50 truncate ${viewMode === 'grid' ? 'mx-auto max-w-[90%]' : ''}`}>
                                                        {type === 'artist'
                                                ...
                                                <div className={`relative z-10 flex-shrink-0 ${viewMode === 'grid' ? 'bg-white/[0.05] rounded-full px-3 py-1 mt-1' : 'text-right'}`}>
                                                    <span className={`font-bold text-[#141413] block ${viewMode === 'grid' ? 'text-xs' : 'text-sm'}`}>
                                                        {plays.toLocaleString()}
                                                        <span className="text-[9px] uppercase tracking-wider text-[#141413]/40 ml-1 font-medium">plays</span>
                                                    </span>
                                                </div>
                                            </motion.div>
                                        );
