          ...
          <div className="bg-[#111] w-full max-w-7xl h-full max-h-[90vh] rounded-3xl border border-[#e8e6dc] flex flex-col overflow-hidden shadow-2xl relative">
            ...
            <div className="p-6 border-b border-[#e8e6dc] flex items-center justify-between bg-[#161618]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[#141413]/50 text-sm">
              ...
              <button
                onClick={onClose}
                className="p-2 hover:bg-[#e8e6dc] rounded-full transition-colors text-[#141413]/50 hover:text-[#141413]"
              >
                <X size={24} />
              </button>
            </div>
            ...
            <div className="p-4 border-b border-[#e8e6dc] flex items-center gap-4 bg-[#111]">
              <div className="relative flex-1 max-w-md">
                <Search
                  size={18}
                  className="absolute left-3 top-1/2 -translate-y-1/2 text-[#141413]/30"
                />
                <input
                  type="text"
                  ...
                  {loading ? (
                    <tr>
                      <td
                        colS
                        pan={5}
                        className="p-8 text-center text-[#141413]/30"
                      >
                        Loading data...
                      </td>
                    </tr>
                          ...
                          <div className="flex items-center gap-3">
                            <div className="w-8 h-8 rounded bg-[#222] overflow-hidden flex-shrink-0 border border-[#e8e6dc]">
                              {item.cover || item.album_cover ? (
                                ...
                                <div className="w-full h-full flex items-center justify-center text-[#141413]/20">
                                  <Music size={12} />
                                </div>
                              )}
                            </div>
